note
	description: "[
		Immutable audit entry for use in model queries and contracts.

		Represents a single audit trail entry with:
		- audit_id: unique identifier
		- record_id: the record being tracked
		- table_name: source table
		- operation: INSERT, UPDATE, or DELETE
		- timestamp: when the change occurred
		- old_values/new_values: JSON representations

		This class is designed for use with MML (Mathematical Model Library)
		to support Design by Contract specifications in SIMPLE_SQL_AUDIT.
	]"
	date: "$Date$"
	revision: "$Revision$"
